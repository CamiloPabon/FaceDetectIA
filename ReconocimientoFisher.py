...
face_reg = cv2.face.FisherFaceRecognizer_create()
face_reg.read("fisher.xml")
...
while(cap.isOpened()):
    ...
    cv2.putText(frame,"Identificacion con fisher ",(10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (200, 255, 10), 3)
